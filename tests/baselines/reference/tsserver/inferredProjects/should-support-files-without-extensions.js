...
Before request
//// [/user/username/projects/project/compile]
let x = 1
...
Info seq  [hh:mm:ss:mss] request:
    {
      "command": "open",
      "arguments": {
        "file": "/user/username/projects/project/compile",
        "fileContent": "let x = 1",
        "scriptKindName": "JS"
      },
      "seq": 2,
...
Info seq  [hh:mm:ss:mss] getConfigFileNameForFile:: File: /user/username/projects/project/compile ProjectRootPath: undefined:: Result: undefined
...
Info seq  [hh:mm:ss:mss] 	Files (1)
	/user/username/projects/project/compile SVC-1-0 "let x = 1"
...
ScriptInfos::
/user/username/projects/project/compile (Open) *new*
    version: SVC-1-0
...
Info seq  [hh:mm:ss:mss] 	FileName: /user/username/projects/project/compile ProjectRootPath: undefined
